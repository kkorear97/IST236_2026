    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.rollButtonContainer}>
          ...
          android_ripple={{color: "#681313"}}
          // Style the button when pressed
          style={({pressed}) => pressed && styles.pressedButton}
          //Whe Pressed open modal screen
        ...
        <Modal visible={modalIsVisible} animationType="slide">
          <SafeAreaView style={styles.modalRoot}>
            ...
            //set teh keyboard type to number pad for only integers
            keyboardType="number-pad"
            //when the text is changed, update the usersGuess
            ...
            style={styles.textInput}
            //placeholder for when it's empty
            placeholder="Enter A Your Wager Here" 
            //set teh keyboard type to number pad for only integers
            keyboardType="number-pad"
            //when the text is changed, update the usersGuess
